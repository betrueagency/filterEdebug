<?php
/** configuration de base de votre installation WordPress.
 *
...
$site_current_hostname = getenv('SITE_HOST');
define( 'WP_SITEURL', $site_current_hostname );
define('WP_HOME',$site_current_hostname);
define( 'PROD_UPLOADS_URL', $site_current_hostname );
