...
add_filter( 'wpc_filter_post_meta_term_name', 'flrt_stock_status_term_name', 15, 2 );
...
add_filter('wpc_filter_taxonomy_term_name', 'flrt_modify_taxonomy_term_name', 15, 2 );
...
add_filter('wpc_filter_term_query_args', 'flrt_exclude_uncategorized_category', 15, 3);
...
add_filter( 'wpc_filter_get_taxonomy_terms', 'flrt_exclude_product_visibility_terms', 15, 2 );
...
add_filter( 'wpc_filter_classes', 'flrt_frontend_filter_classes', 15, 2 );
