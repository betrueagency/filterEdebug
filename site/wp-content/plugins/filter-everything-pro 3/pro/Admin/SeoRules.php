...
class SeoRules
{
    ...
    public function registerHooks()
    {
        ...
        add_filter( 'wpc_input_type_text', array( $this, 'addSeoVarButton' ), 15, 2 );
        add_filter( 'wpc_input_type_textarea', array( $this, 'addSeoVarButton' ), 15, 2 );
        add_filter( 'wpc_input_type_select', array( $this, 'addCustomLabel' ), 15, 2 );
        add_action( 'wpc_after_seo_vars_button', [$this, 'addSeoVarToolTip'] );

        add_filter( 'post_updated_messages', [$this, 'seoRulesActionsMessages'] );
        add_filter( 'bulk_post_updated_messages', [ $this, 'seoRulesBulkActionsMessages' ], 15, 2 );

        add_filter( 'page_row_actions', [$this, 'seoRulesRowActions'], 16, 2 );
