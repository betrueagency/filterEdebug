...
class Admin{
    ...
    public function __construct()
    {
        ...
        add_filter( 'enter_title_here', array($this, 'titlePlaceHolderForSeoRule'), 15, 2 );
            ...
            if ( $the_trident ) {
                if ( isset( $the_trident[ 'first_install' ] ) ) {
                    ...
                    if( ( $instt + MONTH_IN_SECONDS * 2 ) < $tnow ) {
                        add_filter( 'wpc_validate_filter_fields', [ $this, 'sanitizeValues' ], 15, 2 );
                        add_filter( 'wpc_validate_seo_rules', [ $this, 'sanitizeValues' ], 15, 2 );
                    }
                }
            }
        }
